...
public class CodeGenerator {
    ...
    //     // 手动配置数据源
    //     // 【注意修改数据库名】
    //     String url = "jdbc:mysql://localhost:3306/********?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";
    //     String name = "root";
    //     String password = "********";
    //
    //     // 数据库表的设置
    ...
    //     String parent = "com";
    //     // 模块包名
    //     String module = "frank.apibackstage";
    //
    //     // 1. 配置数据源
    ...
    //                         .outputDir("F:\\Java\\Project\\FrankApi\\FrankApi-Backend\\frankapi-backstage" + "/src/main/java")
    //                         // 注释日期
